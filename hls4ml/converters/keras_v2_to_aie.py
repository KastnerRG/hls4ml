...
def register_keras_aie_layer_handler(layer_cname, handler_func):
...
def parse_keras_model(model_arch, reader):
    ...
    # At this stage, very limited set of layers supported by AIE
    skip_layers = ['Dropout']
    # Activation layers
    activation_layers = [
        'Activation',
    ...
    print("Layers supported by Vitis")
